...
public class HangulUtils {
	...
	public static boolean isQueryKorean(String query) {
		// TODO Auto-generated method stub
		int[] unicodeList = HangulUtils.convertStringToUnicode(query);
		
		for (int unicode : unicodeList) {
			if (HangulUtils.HANGUL_BEGIN_UNICODE <= unicode
					&& unicode <= HangulUtils.HANGUL_END_UNICODE) {
				return true;
			}
		}
		return false;
